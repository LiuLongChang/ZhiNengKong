...
@implementation MessageReplyTableViewCell
...
-(void)drawReply{
    ...
    CGSize messageSize = [_message boundingRectWithSize:CGSizeMake(msgBoxWidth - (msgInsetX * 2), MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:textAttrDic context:nil].size;
    ...
    //贝塞尔曲线起点
    CGFloat startX = _headImageView.frame.origin.x + 5.0f;
    ...
    CGPoint ctrlPoint2 = CGPointMake(point2.x, point1.y);
    ...
    CGContextSetFillColorWithColor(context, _messageColor.CGColor);
    ...
    CGRect messageRect = CGRectMake(startPoint.x - (msgInsetX * 2) - messageSize.width, startPoint.y + msgInsetY, messageSize.width, messageSize.height);
    ...
    CGRect timeRect = CGRectMake(startPoint.x - msgBoxWidth - timeSize.width - cornerRadius - msgInsetX, startPoint.y + (messageSize.height - timeSize.height + (msgInsetY * 2)) , timeSize.width, timeSize.height);
