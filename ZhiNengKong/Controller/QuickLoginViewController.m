...
-(void)getVerifyCode{
    ...
    [CloudBL GetLoginCode_Phone:_loginNameTextField.text success:^{
...
-(void)submit{
    ...
    [CloudBL CodeLogin_Phone:_loginNameTextField.text Code:_verifyCodeTextField.text success:^(NSString *HGUID, Token *Token, NSString *UserName) {
        ...
        [Utils_UserDefaultInfo SetUserName:_loginNameTextField.text];
